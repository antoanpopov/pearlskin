...
$router->group(['prefix' => '/pearlskin'], function (Router $router) {
    ...
    $router->get('clients/datatable', [
        'as' => 'admin.pearlskin.client.datatable',
        'uses' => 'ClientController@datatable',
        'middleware' => 'can:pearlskin.clients.index'
    ]);
    ...
    $router->get('manipulations/datatable', [
        'as' => 'admin.pearlskin.manipulation.datatable',
        'uses' => 'ManipulationController@datatable',
        'middleware' => 'can:pearlskin.manipulations.index'
    ]);
    ...
    $router->get('schedules/calendar', [
        'as' => 'admin.pearlskin.schedule.calendar',
        'uses' => 'ScheduleController@calendar',
        'middleware' => 'can:pearlskin.schedules.index'
    ]);
    ...
    $router->get('price-lists-categories/{priceListCategory}/edit', [
        'as' => 'admin.pearlskin.priceListsCategories.edit',
        'uses' => 'PriceListCategoryController@edit',
        'middleware' => 'can:pearlskin.priceListsCategories.edit'
    ]);
    $router->put('price-lists-categories/{priceListCategory}', [
