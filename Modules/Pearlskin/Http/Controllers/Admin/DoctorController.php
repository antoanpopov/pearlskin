...
class DoctorController extends AdminBaseController
{
    ...
    {
        $image = $fileRepository->findFileByZoneForEntity('featured_image', $doctor);
        return view('pearlskin::admin.doctors.edit', compact('doctor', 'featured_image'))->withSuccess(trans('core::core.messages.resource updated', ['name' => trans('pearlskin::doctors.title.doctors')]));
    }
