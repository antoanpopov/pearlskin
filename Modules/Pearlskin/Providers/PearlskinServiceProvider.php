...
class PearlskinServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        view()->composer('home', LatestPostsComposer::class);
    ...
    private function registerThumbnails()
    {
        ...
        $this->app[ThumbnailManager::class]->registerThumbnail('mediumWidget', [
            'fit' => [
                'width' => '480',
                'height' => '270',
        ...
        $this->app[ThumbnailManager::class]->registerThumbnail('largeWidget', [
            'fit' => [
                'width' => '640',
                'height' => '360',
                'callback' => function ($constraint) {
