    ...
    public function getLanguageSwitcher()
    {
        ...
        $languageSwitcher = '<li class="dropdown">
                <a href="#" 
                   ...
                   role="button"
                   aria-haspopup="true"
                   aria-expanded="false">' . LaravelLocalization::getSupportedLocales()[LaravelLocalization::getCurrentLocale()]['native'] .
        ...
        foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties) {
            ...
            $languageSwitcher .= mb_convert_case($properties['native'], MB_CASE_TITLE, "UTF-8") . '</a></li>';
        }
