...
@section('content-header')
    <h1>
        {{ trans('pearlskin::doctors.title.edit') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.pearlskin.doctor.index') }}">{{ trans('pearlskin::doctors.title.list') }}</a></li>
        <li class="active">{{ trans('pearlskin::doctors.title.edit') }}</li>
    </ol>
@stop
        ...
        <div class="col-md-6 col-sm-12">
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    {!! Form::normalCheckbox('is_visible', trans('pearlskin::statuses.visible'), $errors, $doctor) !!}
                    {!! Form::normalCheckbox('has_percent', trans('pearlskin::statuses.has percent'), $errors, $doctor) !!}

                        @mediaSingle('featured_image', $doctor)
