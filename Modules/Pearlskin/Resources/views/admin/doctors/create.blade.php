        ...
        <div class="col-md-6 col-sm-12">
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    {!! Form::normalCheckbox('is_visible', trans('pearlskin::statuses.visible'), $errors) !!}
                    {!! Form::normalCheckbox('has_percent', trans('pearlskin::common.statuses.has percent'), $errors) !!}
