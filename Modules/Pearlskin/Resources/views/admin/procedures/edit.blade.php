...
@section('content-header')
    <h1>
        {{ trans('pearlskin::procedures.title.edit') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i
                        class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li>
            <a href="{{ route('admin.pearlskin.procedure.index') }}">{{ trans('pearlskin::procedures.title.list') }}</a>
        </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                {!! Form::label("procedure_cat_id", trans('pearlskin::common.form.category')) !!}
