...
@section('content-header')
    <h1>
        {{ trans('pearlskin::priceListsCategories.title.list') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i
                        class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li class="active">{{ trans('pearlskin::priceListsCategories.title.list') }}</li>
    </ol>
@stop
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <table class="data-table table table-bordered table-hover">
                        ...
                        <tbody>
                        <?php if (isset($priceListCategories)): ?>
                        <?php foreach ($priceListCategories as $priceListCategory): ?>
                        <tr>
                            <td>
                                <a href="{{ route('admin.pearlskin.priceListsCategories.edit', [$priceListCategory->id]) }}">
                                    {{ $priceListCategory->title }}
                                </a>
                            </td>
                            <td>
                                @if($priceListCategory->is_visible)
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <button class="btn btn-danger btn-flat" data-toggle="modal"
                                            ...
                                            data-action-target="{{ route('admin.pearlskin.priceListsCategories.destroy', [$priceListCategory->id]) }}">
