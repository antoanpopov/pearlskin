...
@section('content-header')
    <h1>
        {{ trans('pearlskin::carousels.title.list') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li class="active">{{ trans('pearlskin::carousels.title.list') }}</li>
    </ol>
@stop
            ...
            <div class="row">
                <div class="btn-group pull-right" style="margin: 0 15px 15px 0;">
                    <a href="{{ route('admin.pearlskin.carousel.create') }}" class="btn btn-primary btn-flat" style="padding: 4px 10px;">
                        <i class="fa fa-pencil"></i> {{ trans('pearlskin::carousels.create') }}
                    </a>
                </div>
            </div>
                ...
                <div class="box-body">
                    <table class="data-table table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('admin.pearlskin.carousel.edit', [$carousel->id]) }}" class="btn btn-default btn-flat"><i class="fa fa-pencil"></i></a>
