...
@section('content-header')
    <h1>
        {{ trans('pearlskin::procedures_categories.title.edit') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.pearlskin.procedures_categories.index') }}">{{ trans('pearlskin::procedures_categories.title.list') }}</a></li>
        <li class="active">{{ trans('pearlskin::procedures_categories.title.edit') }}</li>
    </ol>
@stop
