...
@section('content-header')
    <h1>
        {{ trans('pearlskin::manipulations.title.edit') }}
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('pearlskin::manipulations.title.edit') }}</li>
    </ol>
@stop
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box-footer">
                ...
                <a class="btn btn-danger pull-right btn-flat" href="{{ route('admin.pearlskin.manipulation.index')}}"><i
